...
export function MeshDriftShaderBackground() {
  ...
  useEffect(() => {
    ...
    if (!gl) {
      console.warn("WebGL1 context not supported");
      return;
    }
    ...
    const render = () => {
      ...
      // Uniform values specified in request:
      ...
      // u_finish = vec4(0.00, 0.00, 0.00, 0.09)
      ...
      // u_cursor = vec4(0.0, 2.0, 0.65, 0.46) (cursor: off)
