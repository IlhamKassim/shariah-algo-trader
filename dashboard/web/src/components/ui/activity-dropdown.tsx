...
export function ActivityDropdown({
  ...
  const displayTitle = title ?? `${activities.length} New Activities`;
  const displaySubtitle = subtitle ?? "What's happening around you";
                ...
                >
                  <div className="flex h-10 w-10 shrink-0 items-center justify-center rounded-xl bg-neutral-100 dark:bg-neutral-700 transition-colors duration-300">
                    <span className="text-neutral-600 dark:text-neutral-300">
                      {activity.icon ?? <Bell className="h-4 w-4" />}
                    </span>
                  </div>
