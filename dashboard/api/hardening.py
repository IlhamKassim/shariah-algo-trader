...
class SecurityHeadersMiddleware(BaseHTTPMiddleware):
    async def dispatch(self, request: Request, call_next) -> Response:
        ...
        response.headers["Content-Security-Policy"] = (
            ...
            "img-src 'self' data: https://img.clerk.com https://clerk.shariahtrading.my https://*.clerk.accounts.dev; "
            "connect-src 'self' https://clerk.shariahtrading.my https://*.clerk.accounts.dev wss://clerk.shariahtrading.my; "
            "frame-src 'self' https://clerk.shariahtrading.my https://*.clerk.accounts.dev https://challenges.cloudflare.com; "
